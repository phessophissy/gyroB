...
/**
 * @title GyroBoardfeature-multi-room-dashboard8
 * @notice Helper module for Multi-room dashboard overview
 * @dev Part 8 of the feature-multi-room-dashboard enhancement
 */
