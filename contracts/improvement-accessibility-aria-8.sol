...
/**
 * @title GyroBoardimprovement-accessibility-aria8
 * @notice Helper module for Accessibility improvements with ARIA labels
 * @dev Part 8 of the improvement-accessibility-aria enhancement
 */
contract GyroBoard8Helper {
    uint256 public constant MODULE_ID = 8;
    ...
    function recordAction8(bytes32 roomId, uint256 spinValue)
        external
        validSpin(spinValue)
    {
    ...
    function getModuleStats8(bytes32 roomId)
        external
        view
    ...
    function getUserStats8(address user)
        external
        view
