# Multi-room dashboard overview — Part 5

## Overview

This document covers component 5 of the **Multi-room dashboard overview** enhancement
...
```javascript
import { init5 } from './feature-multi-room-dashboard-5';
