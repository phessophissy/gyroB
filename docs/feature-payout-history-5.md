# Payout history with export support — Part 5

## Overview

This document covers component 5 of the **Payout history with export support** enhancement
...
```javascript
import { init5 } from './feature-payout-history-5';
