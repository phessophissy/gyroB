# Gas benchmark tests for all functions — Part 5

## Overview

This document covers component 5 of the **Gas benchmark tests for all functions** enhancement
...
```javascript
import { init5 } from './test-gas-benchmarks-5';
