# Game replay viewer for past rounds — Part 5

## Overview

This document covers component 5 of the **Game replay viewer for past rounds** enhancement
...
```javascript
import { init5 } from './feature-game-replay-viewer-5';
