# Chat lobby for room participants — Part 10

## Overview

This document covers component 10 of the **Chat lobby for room participants** enhancement
...
```javascript
import { init10 } from './feature-chat-lobby-10';
