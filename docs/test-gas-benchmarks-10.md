# Gas benchmark tests for all functions — Part 10

## Overview

This document covers component 10 of the **Gas benchmark tests for all functions** enhancement
...
```javascript
import { init10 } from './test-gas-benchmarks-10';
