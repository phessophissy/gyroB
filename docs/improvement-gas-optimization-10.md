# Gas optimization for contract calls — Part 10

## Overview

This document covers component 10 of the **Gas optimization for contract calls** enhancement
...
```javascript
import { init10 } from './improvement-gas-optimization-10';
