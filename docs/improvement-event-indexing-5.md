# Event indexing for round history — Part 5

## Overview

This document covers component 5 of the **Event indexing for round history** enhancement
...
```javascript
import { init5 } from './improvement-event-indexing-5';
