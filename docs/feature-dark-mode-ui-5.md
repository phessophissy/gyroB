# Dark mode UI theme with toggle — Part 5

## Overview

This document covers component 5 of the **Dark mode UI theme with toggle** enhancement
...
```javascript
import { init5 } from './feature-dark-mode-ui-5';
